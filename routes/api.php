...
$api->version('v1',[
    ...
    $api->get('config','Controller@appConfig');                            // 客户端配置

    $api->post('verificationCodes', 'VerificationCodesController@store');  // 获取手机短信
    $api->post('user','UsersController@store');                            // 获取用户信息
});
